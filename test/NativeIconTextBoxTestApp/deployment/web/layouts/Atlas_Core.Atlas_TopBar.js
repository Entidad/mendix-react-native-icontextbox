...
const { $ScrollContainer, $Fragment, $Div, $Container, $SidebarToggle, $Image, $MenuBar, $DataView, $FormGroup, $Combobox, $NavigationTree, $Placeholder } = asPluginWidgets({ ScrollContainer, Fragment, Div, Container, SidebarToggle, Image, MenuBar, DataView, FormGroup, Combobox, NavigationTree, Placeholder });
                                                                ...
                                                                <$Div key={"l.Atlas_Core.Atlas_TopBar.layoutGrid2$row0$column2"}
                                                                    ...
                                                                    content={[
                                                                        <$Fragment key={"l.Atlas_Core.Atlas_TopBar.snippetCall2"}
                                                                            ...
                                                                            content={[
                                                                                <$DataView key={"l.Atlas_Core.LanguageSelectorWidget.dataView1.Atlas_Core.Atlas_TopBar"}
                                                                                    $widgetId={"l.Atlas_Core.LanguageSelectorWidget.dataView1.Atlas_Core.Atlas_TopBar"}
                                                                                    class={"mx-name-dataView1 form-horizontal"}
                                                                                    object={MicroflowObjectProperty({
                                                                                        "dataSourceId": "l.33",
                                                                                        "editable": true,
                                                                                        "operationId": "9xTBrpdYAFmzQPDGgtx9fQ",
                                                                                        "argMap": {}
                                                                                    })}
                                                                                    ...
                                                                                    body={[
                                                                                        <$FormGroup key={"l.Atlas_Core.LanguageSelectorWidget.comboBox1$formGroup.Atlas_Core.Atlas_TopBar"}
                                                                                            $widgetId={"l.Atlas_Core.LanguageSelectorWidget.comboBox1$formGroup.Atlas_Core.Atlas_TopBar"}
                                                                                            class={"mx-name-comboBox1 language-selector hide-bg"}
                                                                                            style={{
                                                                                                "--cb-text-color": "var(--font-color-contrast)"
                                                                                            }}
                                                                                            control={[
                                                                                                <$Combobox key={"l.Atlas_Core.LanguageSelectorWidget.comboBox1.Atlas_Core.Atlas_TopBar"}
                                                                                                    $widgetId={"l.Atlas_Core.LanguageSelectorWidget.comboBox1.Atlas_Core.Atlas_TopBar"}
                                                                                                    source={"context"}
                                                                                                    ...
                                                                                                    attributeAssociation={AssociationProperty({
                                                                                                        ...
                                                                                                        "scope": "l.Atlas_Core.LanguageSelectorWidget.dataView1.Atlas_Core.Atlas_TopBar",
                                                                                                    ...
                                                                                                    optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                                                                        ...
                                                                                                        "entity": "System.Language",
                                                                                                        "scope": "l.Atlas_Core.LanguageSelectorWidget.dataView1.Atlas_Core.Atlas_TopBar",
                                                                                                        "operationId": "dEL1OsVSGlaixEwHCwaBBw",
                                                                                                        "sort": []
                                                                                                    })}
                                                                                                    ...
                                                                                                    onChangeEvent={ActionProperty({
                                                                                                        "action": { "type": "callNanoflow", "argMap": { "User": { "widget": "l.Atlas_Core.LanguageSelectorWidget.dataView1.Atlas_Core.Atlas_TopBar", "source": "object" } }, "config": { "nanoflow": () => OCH_UpdateUserLanguage }, "disabledDuringExecution": false },
                                                                                                        "argumentTypes": { }
                                                                                                    })}
                                                                                                    ariaRequired={false}
                                                                                            ...
                                                                                            hasError={ValidationProperty({
                                                                                                "inputWidgetId": "l.Atlas_Core.LanguageSelectorWidget.comboBox1.Atlas_Core.Atlas_TopBar"
                                                                                            })} />
                                                                                    ]}
                                                                                    hideFooter={false} />
                                                                            ]} />
