                                ...
                                footer={[
                                    <$ActionButton key={"p.Administration.ChangePasswordForm.microflowButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "callMicroflow", "argMap": { "AccountPasswordData": { "widget": "$AccountPasswordData", "source": "object" } }, "config": { "operationId": "/c8ztw5v/1WFX8J4Kg4qmw", "validate": "view" }, "disabledDuringExecution": false },
                                    ...
                                    <$ActionButton key={"p.Administration.ChangePasswordForm.cancelButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "s3MsgAvAA1K8wAoc4NPNqw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "3kyVZw2xY1qKv5+E5rRTQQ";
