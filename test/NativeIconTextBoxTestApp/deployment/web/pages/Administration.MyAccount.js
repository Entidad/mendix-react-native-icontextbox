                            ...
                            <$DataView key={"p.Administration.MyAccount.dataView1"}
                                ...
                                body={[
                                        ...
                                        control={[
                                            <$Combobox key={"p.Administration.MyAccount.comboBox3"}
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.MyAccount.dataView1",
                                                    "operationId": "f32YkeOaaVqYlWUlwG/3tg",
                                                    "sort": []
                                                })}
                                    ...
                                    <$ActionButton key={"p.Administration.MyAccount.microflowTrigger1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "callMicroflow", "argMap": { "Account": { "widget": "$Account", "source": "object" } }, "config": { "operationId": "eKVrxTZpVFqPDgkSarcy5g" }, "disabledDuringExecution": false },
                                ...
                                footer={[
                                    <$ActionButton key={"p.Administration.MyAccount.saveButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.Administration.MyAccount.dataView1", "source": "object" } }, "config": { "operationId": "yjO9HGFxkFeWwCb/ecvuqg", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />,
                                    <$ActionButton key={"p.Administration.MyAccount.cancelButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "WCx3Szf7PFyOUGqE6vUPgw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "o31fL8r2tlmtCRb6fdhEqg";
