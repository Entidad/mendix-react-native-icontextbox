    ...
    <$Div key={"p.FeedbackModule.ShareFeedback.layoutGrid1"}
        ...
        content={[
            <$Div key={"p.FeedbackModule.ShareFeedback.layoutGrid1$row0"}
                ...
                class={"row align-children-start"}
                content={[
                            ...
                            <$DataView key={"p.FeedbackModule.ShareFeedback.dataView5"}
                                ...
                                body={[
                                    ...
                                    <$Container key={"p.FeedbackModule.ShareFeedback.container3"}
                                        ...
                                        class={"mx-name-container3 flex-row flexcontainer justify-content-end spacing-inner-bottom"}
                                        style={{
                                            "gap": "8px"
                                        }}
                                        renderMode={"div"}
...
export const cancelChangesOperationId = "Dl92PEq7n1GIYH4r0CULdw";
export const style = {};
