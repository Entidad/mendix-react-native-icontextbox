                            ...
                            <$DataView key={"p.Administration.Account_Edit.dataView1"}
                                        ...
                                        control={[
                                            <$Combobox key={"p.Administration.Account_Edit.comboBox2"}
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.Account_Edit.dataView1",
                                                    "operationId": "GYhDOPOcyFaSHBMWAjhAuw",
                                                    "sort": [
                                                        [
                                                            "Name",
                                                            "asc"
                                        ...
                                        control={[
                                            <$Combobox key={"p.Administration.Account_Edit.comboBox3"}
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.Account_Edit.dataView1",
                                                    "operationId": "2DaEaONOYFuKnATPI6vMAA",
                                                    "sort": []
                                                })}
                                                optionsSourceAssociationCaptionType={"attribute"}
                                                optionsSourceAssociationCaptionAttribute={ListAttributeProperty({
                                        ...
                                        control={[
                                            <$Combobox key={"p.Administration.Account_Edit.comboBox4"}
                                                ...
                                                optionsSourceAssociationDataSource={DatabaseObjectListProperty({
                                                    ...
                                                    "scope": "p.Administration.Account_Edit.dataView1",
                                                    "operationId": "mmKhgCn/Q1m/dqesfRytLg",
                                                    "sort": [
                                                        [
                                                            "RawOffset",
                                                            "asc"
                                        ...
                                        contents={[
                                            <$ActionButton key={"p.Administration.Account_Edit.microflowTrigger1"}
                                                ...
                                                action={ActionProperty({
                                                    "action": { "type": "callMicroflow", "argMap": { "Account": { "widget": "$Account", "source": "object" } }, "config": { "operationId": "dOUroCtvjlCIx1tgEWa22Q" }, "disabledDuringExecution": false },
                                ...
                                footer={[
                                    <$ActionButton key={"p.Administration.Account_Edit.saveButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "saveChanges", "argMap": { "$object": { "widget": "p.Administration.Account_Edit.dataView1", "source": "object" } }, "config": { "operationId": "/a8RnOpgf16OhrUJvIUQbg", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />,
                                    <$ActionButton key={"p.Administration.Account_Edit.cancelButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "RzHVyaf6V12i8NuyP0O+Mw", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "9UySP28ZmV6yLbXzUNd7GQ";
