...
import * as DatagridDropdownFilterWidgetModule from "C:/mx/widgets/mendix-react-native-icontextbox/test/NativeIconTextBoxTestApp/deployment/web/widgets/com/mendix/widget/web/datagriddropdownfilter/DatagridDropdownFilter.mjs";
                                        ...
                                        "content": [
                                            <$Datagrid key={"p.Administration.Account_Overview.dataGrid21"}
                                                ...
                                                datasource={DatabaseObjectListProperty({
                                                    ...
                                                    "operationId": "uiAQinDLJV2gxbnsf+4mPQ",
                                                    "sort": [
                                                        [
                                                            "FullName",
                                                            "asc"
                                                        ...
                                                        "filter": [
                                                            <$DatagridDropdownFilter key={"p.Administration.Account_Overview.drop_downFilter1"}
                                                                ...
                                                                refOptions={DatabaseObjectListProperty({
                                                                    "dataSourceId": "p.13",
                                                                    "entity": "System.UserRole",
                                                                    "operationId": "STjVv7KU4VOpgiuBv5Plqw",
                                                                    "sort": []
                                                                })}
                                                        ...
                                                        "content": TemplatedWidgetProperty({
                                                            ...
                                                            "children": () => [
                                                                ...
                                                                <$ActionButton key={"p.Administration.Account_Overview.actionButton4"}
                                                                    ...
                                                                    action={ActionProperty({
                                                                        "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p.Administration.Account_Overview.dataGrid21", "source": "object" } }, "config": { "closePage": false, "operationId": "BGaBV8e2OVKrhxOPenBo4A" }, "disabledDuringExecution": true },
                                                                        "abortOnServerValidation": true
                                                                    })} />
                                                            ]
                                                        }),
                                                ...
                                                filtersPlaceholder={[
                                                    <$ActionButton key={"p.Administration.Account_Overview.actionButton1"}
                                                        ...
                                                        action={ActionProperty({
                                                            "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "BOs6DcVtJ1udOAknVTWgZw", "validate": "view" }, "disabledDuringExecution": true },
                                                            "abortOnServerValidation": true
                                                        })} />,
                                                    <$ActionButton key={"p.Administration.Account_Overview.actionButton2"}
                                                        ...
                                                        action={ActionProperty({
                                                            "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "I5Z8IWfZglmp4dYCZv8abw", "validate": "view" }, "disabledDuringExecution": true },
                                                            "abortOnServerValidation": true
                                                        })} />
                                                ]}
