                                ...
                                footer={[
                                    <$ActionButton key={"p.Administration.ChangeMyPasswordForm.microflowButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "callMicroflow", "argMap": { "AccountPasswordData": { "widget": "$AccountPasswordData", "source": "object" } }, "config": { "operationId": "cca+q2CLrVWU8YAMzMBW7g", "validate": "view" }, "disabledDuringExecution": false },
                                    ...
                                    <$ActionButton key={"p.Administration.ChangeMyPasswordForm.cancelButton1"}
                                        ...
                                        action={ActionProperty({
                                            "action": { "type": "cancelChanges", "argMap": {}, "config": { "operationId": "Iqo52+OBc1+m1t4HAVgKOQ", "closePage": true }, "disabledDuringExecution": true },
                                            "abortOnServerValidation": true
                                        })} />
                                ]} />
                        ]} />
...
export const cancelChangesOperationId = "XhI761wmZliGUqbRv07uSQ";
