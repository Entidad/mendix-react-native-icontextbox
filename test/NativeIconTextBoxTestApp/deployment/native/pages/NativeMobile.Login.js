...
import { mainContent, sidebar } from "C:/mx/widgets/mendix-react-native-icontextbox/test/NativeIconTextBoxTestApp/deployment/native/layouts/Atlas_Core.NativePhone_TopBarOnly.js";
        ...
        content={[
            <$DataView key="p2.NativeMobile.Login.dataView2"
                ...
                object={NanoflowObjectProperty({
                    "dataSourceId": "p2.4",
                    "editable": true,
                    "source": { "nanoflow": () => require("C:/mx/widgets/mendix-react-native-icontextbox/test/NativeIconTextBoxTestApp/deployment/native/nanoflows/NativeMobile.DSS_CreateLoginContext").DSS_CreateLoginContext },
                    "argMap": {}
                })}
                content={[
                    <$TextBox key="p2.NativeMobile.Login.textBox3"
                        ...
                        inputValue={AttributeProperty({
                            ...
                            "isList": false,
                            "validation": { "message": t([ "A valid email address is required." ]), "expression": { "expr": { "type": "function", "name": ">", "parameters": [ { "type": "function", "name": "length", "parameters": [ { "type": "function", "name": "toString", "parameters": [ { "type": "variable", "variable": "value" } ] } ] }, { "type": "literalNumeric", "value": "0" } ] }, "args": {} } },
                            "formatting": { }
                        })}
                        isPassword={false}
                    ...
                    <$TextBox key="p2.NativeMobile.Login.textBox4"
                        ...
                        inputValue={AttributeProperty({
                            ...
                            "onChange": { "type": "doNothing", "argMap": {}, "config": {}, "disabledDuringExecution": false },
                            "isList": false,
                            "validation": { "message": t([ "A password is required." ]), "expression": { "expr": { "type": "function", "name": ">", "parameters": [ { "type": "function", "name": "length", "parameters": [ { "type": "function", "name": "toString", "parameters": [ { "type": "variable", "variable": "value" } ] } ] }, { "type": "literalNumeric", "value": "0" } ] }, "args": {} } },
                            "formatting": { }
                        })}
                        isPassword={true}
                        placeholder={ExpressionProperty({
                    ...
                    <$Button key="p2.NativeMobile.Login.actionButton2"
                        ...
                        onClick={ActionProperty({
                            "action": { "type": "callNanoflow", "argMap": { "Login": { "widget": "p2.NativeMobile.Login.dataView2", "source": "object" } }, "config": { "nanoflow": () => require("C:/mx/widgets/mendix-react-native-icontextbox/test/NativeIconTextBoxTestApp/deployment/native/nanoflows/NativeMobile.ACT_SignInUser").ACT_SignInUser }, "disabledDuringExecution": false }
                        })}
                        accessible={false} />,
