...
startApp({
    ...
    "systemTexts": {
        ...
        "mendix.lib.Validations.range_decimal": [
            "Decimal value has too many digits."
        ],
        ...
        "mxui.sys.UI.background_synchronization_error": [
            "Objects that are currently being synchronized, can not be committed while the synchronization is running. Please wait for synchronization to be finished, then commit again."
        ]
    },
    ...
    "registerPages": () => {
        NativeUI.registerPage("NativeMobile.Home_Native", ()=> require("C:/mx/widgets/mendix-react-native-icontextbox/test/NativeIconTextBoxTestApp/deployment/native/pages/NativeMobile.Home_Native"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
        NativeUI.registerPage("NativeMobile.Chat_demo", ()=> require("C:/mx/widgets/mendix-react-native-icontextbox/test/NativeIconTextBoxTestApp/deployment/native/pages/NativeMobile.Chat_demo"), {"sidebar":false,"showBottomBar":false,"type":"Default"});
    },
    "animationEnabled": true,
    "deploymentID": "639228369815096096",
